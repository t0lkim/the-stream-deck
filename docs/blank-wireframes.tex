...
\noindent
\begin{center}
{\fontsize{13}{16}\selectfont\bfseries StreamDeck Pi -- Blank Wireframe (70mm)}\\[1pt]
...
\begin{tikzpicture}[x=0.92mm, y=0.92mm]
  ...
  % Feet
  \draw[gray!25, line width=0.2pt] (15,-4) circle (2.5);
  \draw[gray!25, line width=0.2pt] (\cw-15,-4) circle (2.5);
...
\noindent
\begin{center}
{\fontsize{13}{16}\selectfont\bfseries StreamDeck Pi -- Blank Wireframe (102mm)}\\[1pt]
