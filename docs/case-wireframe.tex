...
\noindent
\begin{center}
{\fontsize{13}{16}\selectfont\bfseries StreamDeck Pi -- Front Panel Wireframes (70mm height)}\\[1pt]
...
\begin{tikzpicture}[x=0.92mm, y=0.92mm]
  ...
  \draw[gray!35, line width=0.3pt] (15,-4) circle (2.5);
  \draw[gray!35, line width=0.3pt] (\cw-15,-4) circle (2.5);
